...
export const ButtonHeroVertical = ({ title, icon }: IProps) => {
  ...
  return (
    <div
      className="p-3 rounded-xl border border-transparent shadow cursor-pointer flex w-full space-x-2 items-center bg-white hover:bg-primary hover:shadow-none"
